        ...
        <div className="flex-1">
          ...
          <div className="flex items-center gap-4 mt-6">
            <img
              ...
              src="https://github.com/GabrielFernella.png" alt="avatar" />

            <div className="leading-relaxed">
              <strong className="font-bold text-2xl block">Gabriel Fernella</strong>
              <span className="text-gray-200 text-sm block">Learning with you</span>
            </div>
          </div>
        </div>
...
//flex-1 mantêm o elemento flexível
